...
export type EngineEvent =
  | { type: 'SynchronicityOccurred'; payload: { layer: string; magnitude: number } }
  | { type: 'BeliefUpdated'; payload: { key: string } }
  | { type: 'LevelTransitioned'; payload: { from: string; to: string } };
